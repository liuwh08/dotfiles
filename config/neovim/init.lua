...
require('lazy').setup({
  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    config = function()
        ...
        vim.api.nvim_set_keymap('n', "]c", "<cmd>Gitsigns next_hunk<CR>", { noremap = true, silent = true, desc = "Gitsigns: Next hunk" })
        vim.api.nvim_set_keymap('n', "[c", "<cmd>Gitsigns prev_hunk<CR>", { noremap = true, silent = true, desc = "Gitsigns: Prev hunk" })
